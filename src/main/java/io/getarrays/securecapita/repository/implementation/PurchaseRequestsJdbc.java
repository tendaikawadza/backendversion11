...
//        String purchaseRequesitionImageUrl = setPurchaseRequesitionImageUrl(purchaseRequisition.getId());
//     //   purchaseRequisition.setSignatureUrl(purchaseRequesitionImageUrl)   ;
//                                                  //.setImageUrl(userImageUrl);
//        saveSignature(purchaseRequisition.getFullName(), image);
//        jdbc.update(UPDATE_PURCHASE_REQUEST_IMAGE_QUERY, of("imageUrl", purchaseRequesitionImageUrl, "id", purchaseRequisition.getId()));
//
//    }
//
//
